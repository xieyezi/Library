        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 修改 <small>资料</small></div>
                    <p class="page-header-description">修改资料</p>
                </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">修改个人资料</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form " action="./AdminPersonalServlet" method="post">
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">管理员ID<span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdminId" name="AdminId" value="<%=systemAdmin.getAdminId()%>" readonly="readonly">

                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">原密码<span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="oldPassword" name="oldPassword" placeholder="请输入原密码" required="required">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="newPassword" name="newPassword" placeholder="请输入新密码" required="required">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="newPasswordagain" name="newPasswordagain" placeholder="再次输入新密码" required="required">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdminPhone" name="AdminPhone" value="<%=systemAdmin.getAdminPhone()%>" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdminEmail" name="AdminEmail" value="<%=systemAdmin.getAdminEmail()%>" >
