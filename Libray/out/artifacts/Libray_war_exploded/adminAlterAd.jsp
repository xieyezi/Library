        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 修改 <small>管理员</small></div>
                    <p class="page-header-description">修改管理员</p>
                </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">修改图书馆管理员信息</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form " action="./AdminAlterAdServlet" method="post">
                                <%
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdName" name="AdName" value="<%=searchresult.get(i).getAdName()%>">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdPassword" name="AdPassword" value="<%=searchresult.get(i).getAdPassword()%>">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdPhone" name="AdPhone" value="<%=searchresult.get(i).getAdPhone()%>">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdEmail" name="AdEmail" value="<%=searchresult.get(i).getAdEmail()%>">
...
<script>
    ...
    function onBlurBookId() {
        ...
        location.href="./AlterAdCheckServlet?AdId="+UserId.toString();
    }
</script>
</body>
