                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form " action="./AdPersonalChangeServlet" method="post">
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">管理员ID<span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdId" name="AdId" value="<%=bookadmin.getAdId()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="newPassword" name="newPassword" placeholder="请输入新密码">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="newPasswordagain" name="newPasswordagain" placeholder="再次输入新密码">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Phone" name="Phone" value="<%=bookadmin.getAdPhone()%>" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Email" name="Email" value="<%=bookadmin.getAdEmail()%>" >
