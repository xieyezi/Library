...
@WebServlet("/AdAddBookServlet")
public class AdAddBookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        bookAdminOperation.addBook(BookId,BookName,Author,Translator,Price,ISBNCode,ComeUpTime,PublishCompany,EnteringMen);
        bookAdminOperation.closeConnection();
        response.sendRedirect("adAddBook.jsp?add=yes");
    }
}
