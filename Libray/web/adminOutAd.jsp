...
<%
    ...
    Vector<BookAdmin> searchresult = (Vector<BookAdmin>) request.getAttribute("searchresult");
%>
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>系统管理员-删除图书管理员</title>
        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 删除 <small>管理员</small></div>
                    <p class="page-header-description">删除管理员</p>
                </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">删除图书馆管理员</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form " action="./AdminOutAdServlet" method="post">
                                <%
                                    if (searchresult==null){
                                %>
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">管理员ID <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdId" name="AdId" placeholder="请输入管理员ID" required="required" onblur="onBlurBookId()">
                                ...
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">管理员ID <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="id" name="id" value="<%=searchresult.get(i).getAdId()%>" readonly="readonly" >

                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">管理员姓名 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdName" name="AdName" value="<%=searchresult.get(i).getAdName()%>" readonly="readonly">

                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">管理员密码 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdPassword" name="AdPassword" value="<%=searchresult.get(i).getAdPassword()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdPhone" name="AdPhone" value="<%=searchresult.get(i).getAdPhone()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="AdEmail" name="AdEmail" value="<%=searchresult.get(i).getAdEmail()%>" readonly="readonly">
