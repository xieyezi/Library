                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form " action="./AdminOutReaderServlet" method="post">
                                <%
                                    if (searchresult==null){
                                %>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="UserName" name="UserName" value="<%=user.get(i).getUserName()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Departments" name="Departments" value="<%=searchresult.get(i).getDepartments()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Major" name="Major" value="<%=searchresult.get(i).getMax()%>" readonly="readonly" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Phone" name="Phone" value="<%=searchresult.get(i).getPhone()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="Email" name="Email" value="<%=searchresult.get(i).getEmail()%>" readonly="readonly">
                                ...
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">在借数量 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="LendedNum" name="LendedNum" value="<%=searchresult.get(i).getLendedNum()%>" readonly="readonly">
...
<script>
    ...
    function onBlurBookId() {
        ...
        location.href="./OutReaderSearchServlet?UserId="+UserId.toString();
    }
</script>
</body>
