                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">搜索图书信息</div>
                        </div>
                        <div class="widget-body  am-fr">

                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-6 am-u-lg-offset-3 am-u-md-offset-3"
                                 style="margin-bottom: 3%;">
                                <form action="./AdSearchBookServlet" method="post" id="searchForm">
                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                    ...
                                    <tr class="even gradeX">
                                        ...
                                        <td class="am-text-middle"><%=searchresult.get(i).getBookId()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getBookName()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getAuthor()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getTranslator()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getPrice()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getPublishCompany()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getComeUpTime()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getISBNCode()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getEnteringMen()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getEnteringDate()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getState()%>
                                        </td>
                                    </tr>
                                    <%}%>
                                    <!-- more data -->
