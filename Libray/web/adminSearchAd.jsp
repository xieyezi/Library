                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                    ...
                                    <tr class="even gradeX">
                                        ...
                                        <td class="am-text-middle"><%=searchresult.get(i).getAdId()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getAdName()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getAdPhone()%>
                                        </td>
                                        <td class="am-text-middle"><%=searchresult.get(i).getAdEmail()%>
                                        </td>
                                    </tr>
                                    <%}%>
                                    <!-- more data -->
