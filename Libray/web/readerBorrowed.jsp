...
<%
    ...
    Vector<BorrowRecord> records= borrowRecordOperation.getBorrowed(UserId);
                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                    ...
                                    <tr class="even gradeC">
                                        ...
                                        <td class="am-text-middle"><%=records.get(i).getBorrowTime()%>
                                        </td>
                                        <td class="am-text-middle"><%=records.get(i).getReturnTime()%>
                                        </td>
                                        </td>
                                    </tr>
                                    <!-- more data -->
